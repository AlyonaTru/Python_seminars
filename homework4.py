...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file('filek_1.txt', create_str(koef1))
write_file('filek_2.txt', create_str(koef2))

# нахождение суммы многочлена

with open('filek_1.txt', 'r') as data:
    st1 = data.readlines()
with open('filek_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file('filek_res.txt', create_str(lst_new))
with open('filek_res.txt', 'r') as data:
    st3 = data.readlines()
